...
// Register all 11 procedural animation ECS systems into the world.
...
//   7.75 MeshGenerationSystem   — procedural bone cage geometry from RigTransforms
//   9. AnimationLogSystem     — JSONL telemetry via AnimationLogger
